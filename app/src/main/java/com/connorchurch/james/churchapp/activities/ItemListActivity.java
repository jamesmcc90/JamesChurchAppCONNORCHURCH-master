...
public class ItemListActivity extends FragmentActivity implements OnItemSelectedListener {
    ...
    public void onBackPressed(){
        Intent first = new Intent(ItemListActivity.this, MainActivity.class);
        startActivity(first);
