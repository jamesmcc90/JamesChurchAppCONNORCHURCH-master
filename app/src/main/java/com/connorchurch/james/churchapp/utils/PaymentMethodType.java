package com.connorchurch.james.churchapp.utils;
...
public enum PaymentMethodType {
    ...
    public static com.connorchurch.james.churchapp.utils.PaymentMethodType forType(@Nullable String paymentMethodType) {
        for (com.connorchurch.james.churchapp.utils.PaymentMethodType type
                : values()) {
    ...
    public static com.connorchurch.james.churchapp.utils.PaymentMethodType forType(PaymentMethodNonce paymentMethodNonce) {
    ...
    public static CardType[] getCardsTypes(Set<String> supportedCardTypes) {
        ...
        for (String cardType : supportedCardTypes) {
            com.connorchurch.james.churchapp.utils.PaymentMethodType paymentMethodType =
                    com.connorchurch.james.churchapp.utils.PaymentMethodType.forType(cardType);
     ...
     * {@link com.braintreepayments.api.dropin.utils.PaymentMethodType}.
     */
     ...
     * com.braintreepayments.api.dropin.utils.PaymentMethodType}.
     */
    ...
    /**
     * @return A {@link String} name of the {@link com.braintreepayments.api.dropin.utils.PaymentMethodType} as it is categorized by
     * Braintree.
     */
